/*
  wespota_alternate_config.h - user configuration overrides wespota_config.h for WESPOTA
...
#ifndef _WESPOTA_ALTERNATE_CONFIG_H_
#define _WESPOTA_ALTERNATE_CONFIG_H_

// force the compiler to show a warning to confirm that this file is inlcuded
#warning **** wespota_alternate_config.h: Using Settings from this File ****

/*****************************************************************************************************\
 * USAGE:
 *   To modify the stock configuration without changing the wespota_config.h file:
 *   (1) copy this file to "wespota_alternate_config.h" (It will be ignored by Git)
 *   (2) define your own settings below
 *   (3) for platformio:
 *         define HAVE_ALTERNATE_CONFIG as a build flags.
 *         ie1 : export PLATFORMIO_BUILD_FLAGS='-DHAVE_ALTERNATE_CONFIG'
 *         ie2 : enable in file platformio.ini
 *               "build_flags = -Wl,-Tesp8266.flash.1m0.ld -DHAVE_ALTERNATE_CONFIG"
 ******************************************************************************************************
 * ATTENTION:
...
//  #define USE_MQTT_TLS_CA_CERT                   // Use LetsEncrypt Certificate from wespota_letsencrypt.h - Not supported with core 2.3.0
...
#endif  // _WESPOTA_ALTERNATE_CONFIG_H_
